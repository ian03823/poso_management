...
@section('title','POSO Digital Ticket | Set New Password')
...
<div class="container py-4" style="max-width:520px">
  ...
  <div class="card shadow-sm border-0">
    <div class="card-body">
      <form method="POST" action="{{ route('violator.password.forgot.update') }}">
        @csrf
        ...
        <button class="btn btn-success mt-3">Save password</button>
      </form>
    </div>
  </div>
</div>
